...
import sysinfo
from monitor import CpuMonitor, MemoryMonitor, DiskMonitor, PortMonitor
...
class Node(object):
    def __init__(self, ip):
        ...
        self.cpu_monitor = CpuMonitor(self.id)
        self.memory_monitor = MemoryMonitor(self.id)
        self.disk_monitor = DiskMonitor(self.id)
        self.port_monitor = PortMonitor(self.id)
