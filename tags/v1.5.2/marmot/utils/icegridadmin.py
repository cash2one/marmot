...
class IceGridNodeUnreachableException(IceGrid.NodeUnreachableException):
    pass


class IceGridApplicationNotExistException(IceGrid.ApplicationNotExistException):
    pass
