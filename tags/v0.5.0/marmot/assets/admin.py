...
class ServerAdmin(admin.ModelAdmin):
    list_display = ('cabinet__num', 'hostname', 'listen_ip', 'os', 'manufacturer', 'product_model')
    list_filter = ('cabinet__num', 'hostname')
    search_fields = ('hostname', 'listen_ip')
...
class NetworkDeviceAdmin(admin.ModelAdmin):
    list_display = ('cabinet__num', 'num', 'device_type', 'position', 'manufacturer', 'device_model')
