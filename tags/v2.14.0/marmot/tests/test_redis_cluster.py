...
#     def setUp(self):
#         self.rc = RedisClusterMgt(
#             startup_nodes=[{"host": "192.168.21.49", "port": "7320"},
#                            {"host": "192.168.21.50", "port": "7320"},
#                            {"host": "92.168.21.51", "port": "7320"},
#                            {"host": "92.168.21.62", "port": "7320"},
#                            {"host": "92.168.21.63", "port": "7320"},
#                            {"host": "92.168.21.64", "port": "7320"},
#                            {"host": "192.168.21.49", "port": "7321"},
#                            {"host": "192.168.21.50", "port": "7321"},
#                            {"host": "92.168.21.51", "port": "7321"},
#                            {"host": "92.168.21.62", "port": "7321"},
#                            {"host": "92.168.21.63", "port": "7321"},
#                            {"host": "92.168.21.64", "port": "7321"}]
#         )
#
#     def test_info(self):
#         pprint.pprint(self.rc.info())
