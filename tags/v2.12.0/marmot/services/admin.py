...
from .models import (
    ...
    TomcatAppSql, TomcatAppDB, TomcatAppNode, TomcatServerWarDir, TomcatAppStatic
)
...
@admin.register(TomcatAppStatic)
class TomcatAppStaticAdmin(admin.ModelAdmin):
    list_display = ['id', 'package', 'note', 'tomcat_app', 'active', 'md5', 'user', 'create_time']
