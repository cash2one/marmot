...
from .models import (
    ...
    ActiveMqMonitor, SpringCloudMonitor, ZooKeeperMonitor
)
from .forms import (
    RedisClusterMonitorForm, RedisNodeForm,
    ESMonitorForm, Neo4jMonitorForm, HBaseClusterMonitorForm,
    ActiveMqMonitorForm, SpringCloudMonitorForm, ZooKeeperMonitorForm
)
...
class SpringCloudMonitorInfo(SpringCloudMonitorDetail):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['monitor_info'] = json.dumps(self.object.get_runtime_info(), indent=4)
        return context
