...
from .models import (
    Idc, Cabinet, Server,
    ProcessMonitor, NetworkDevice, NetCard
)
...
class ServerForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if 'initial' in kwargs:
            self.fields['master_host'].queryset = Server.objects.filter(type=1).exclude(id=self.instance.id)
