...
nohup celery worker -A marmot -l info > ../celeryworker_nohup.out 2>&1 &
sleep 1
nohup celery beat -A marmot -l info > ../celerybeat_nohup.out 2>&1 &
sleep 1
nohup uwsgi marmot_uwsgi.ini > ../uwsgi_nohup.out 2>&1 &
