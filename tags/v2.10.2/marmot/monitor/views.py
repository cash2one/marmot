...
from .models import (
    RedisClusterMonitor, RedisNode, ESMonitor, Neo4jMonitor, HBaseClusterMonitor
)
from .forms import (
    RedisClusterMonitorForm, RedisNodeForm, ESMonitorForm, Neo4jMonitorForm, HBaseClusterMonitorForm
)


RDS = redis.StrictRedis(host=settings.REDIS_HOST, port=settings.REDIS_PORT, db=settings.REDIS_DB)

ERR_LOG = logging.getLogger('marmot')
