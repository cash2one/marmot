...
from .views import (
    ...
    TomcatGroupCreate, TomcatGroupUpdate, TomcatGroupDetail, TomcatGroupDelete, TomcatGroupList,
    ...
    TomcatAppWarCreate, TomcatAppWarUpdate, TomcatAppWarDelete, TomcatAppWarList, active_war_package,
    TomcatAppStaticCreate, TomcatAppStaticUpdate, TomcatAppStaticDelete, TomcatAppStaticList, active_static_package,
    TomcatAppSqlCreate, TomcatAppSqlUpdate, TomcatAppSqlDelete, TomcatAppSqlList,
    tomcat_server_switch, push_war_to_tomcat, push_static_to_web_html, backup_database, execute_sql,
