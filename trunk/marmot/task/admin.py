...
from .models import (
    TaskIce, TaskFirewall, FirewallGoal,
    TaskTomcat, Task, TaskDNS, TaskSpringCloud
)
...
class TaskAdmin(admin.ModelAdmin):
    list_display = ['id', 'workflowactivity', 'content_type', 'content_object', 'create_time']
...
@admin.register(TaskSpringCloud)
class TaskSpringCloudAdmin(admin.ModelAdmin):
    list_display = ['create_time', 'name', 'note']
