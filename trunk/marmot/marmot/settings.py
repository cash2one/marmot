...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '192.168.162.91', '172.16.20.48']
...
CAS_AUTH_URL = 'http://192.168.162.108:8005/validate'
CAS_MAIN_URL = 'http://192.168.162.108:8005'
...
# MAIN_DOMAIN = 'http://192.168.162.91:8100'

MAIN_URL = 'http://127.0.0.1:8100'
MAIN_DOMAIN = 'http://127.0.0.1:8100'

# MAIN_URL = 'http://192.168.23.115:8100'
...
CELERYBEAT_SCHEDULE = {
    ...
    'kafka-monitor-every-180s': {
        'task': 'task.kafka_monitor',
