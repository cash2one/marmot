...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '192.168.162.91', '172.16.20.48','172.16.20.202','192.168.56.105']
...
MAIN_URL = 'http://192.168.56.105:8000'
...
# Periodic Tasks
CELERYBEAT_SCHEDULE = {
    'redis-cluster-monitor-every-90': {
