...
from .views import (
    ...
    KafkaMonitorCreate, KafkaMonitorUpdate, KafkaMonitorDetail,
    KafkaMonitorDelete, KafkaMonitorList
)
...
urlpatterns = [
    ...
    url(r'^kafka/create/$', KafkaMonitorCreate.as_view(), name='kafka_monitor_create'),
    url(r'^kafka/(?P<pk>\d+)/update/$', KafkaMonitorUpdate.as_view(), name='kafka_monitor_update'),
    url(r'^kafka/(?P<pk>\d+)/detail/$', KafkaMonitorDetail.as_view(), name='kafka_monitor_detail'),
    url(r'^kafka/(?P<pk>\d+)/delete/$', KafkaMonitorDelete.as_view(), name='kafka_monitor_delete'),
    url(r'^kafka/list/$', KafkaMonitorList.as_view(), name='kafka_monitor_list_view'),
]
